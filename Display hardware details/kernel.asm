...
;************************************************************************************************
[SEGMENT .data]
    strWelcomeMsg   db  "JOSH Extended Version Enter 'help' to dispaly menu", 0x00
	strPrompt		db	"Command>>", 0x00
	cmdMaxLen		db	255			;maximum length of commands

	strOsName		db	"JOSH_Extended", 0x00	;OS details
	strMajorVer		db	"0", 0x00
	strMinorVer		db	".04", 0x00
	strTest			db	"Modified by Chamith Eranda Weerathunga SE/2019/002.", 0x00
